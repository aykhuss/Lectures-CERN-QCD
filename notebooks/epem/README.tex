...
\label{sec:org6b7e125}

\subsection{The squared Matrix Element}
\label{sec:orgd5f00b8}
...
\end{minted}
\section{Playground}
\label{sec:orgff59eb2}

\subsection{Export source code}
\label{sec:org6571536}
